            ...
            @foreach ($users as $user)
                ...
                <div class="relative w-36 md:w-52 lg:w-56 group m-auto mb-6">
                    <div data-aos="zoom-in-up">
                        ...
                        <span
                            class="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/4 text-xl font-bold text-white hidden group-hover:block duration-500">
                        ...
                        <a href="/movies/{{ $link }}-{{ $newname }}">
                            <button
                                class="w-32 border rounded-3xl py-1 px-2 lg:py-2 lg:px-4 bg-600 text-base text-white absolute top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-2/3 hidden group-hover:block duration-500">View
                                details</button>
                        </a>
                        <h2 class="text-black dark:text-white text-base font-bold ml-2 truncate">{{ $user['title'] }}
                        </h2>
            ...
            <div class="relative w-36 md:w-52 lg:w-56 group m-auto mb-6">
                <div data-aos="zoom-in-up">
                    ...
                    <a href="/series/{{ $serie['init_id'] }}-{{ $newname2 }}">
                        <button
                            class="w-32 border rounded-3xl py-2 px-4 bg-600 text-base text-white absolute top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-2/3 hidden group-hover:block duration-500">View
                            details</button>
                    </a>
        ...
        @for ($j = 1; $j <= 4; $j++)
            ...
            <div class="relative w-36 md:w-52 lg:w-56 group m-auto mb-6">
                <div data-aos="zoom-in-up">
                    ...
                    ?>
                    <span
                        class="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/4 text-2xl font-bold text-white hidden group-hover:block duration-500">{{ $genes }}</span>
                    <a href="#">
                        <button
                            class="w-32 border rounded-3xl py-2 px-4 bg-600 text-base text-white absolute top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-2/3 hidden group-hover:block duration-500">View
                            details</button>
