...
<meta charset="UTF-8">
    ...
    <style>
        ...
        #pagination-content{
            ...
            height: 240vh;
            background: black;
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("resources/images/20211004.jpg");
...
<body>
            ...
            <?php
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  <td class='tdview'>
                      ...
                      <form action='viewDetails2.php?name=",$row['movie_name'],"' method='GET'>
                      <input type='hidden' name='phpVariable' value='",$row['a_id'],"'>
                      <button type='submit' name='submit' class='btn' >Download</button>
                     </form>
    ...
    <script>
        ...
        var page = document.getElementById("page-go").value;
            ...
            window.location.href = 'browse.php?page_no='+page;   
        }
    </script>
</body>
